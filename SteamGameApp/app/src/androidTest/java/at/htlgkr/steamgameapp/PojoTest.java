...
public class PojoTest {
    @Test
    public void loadGames_size() throws IOException, ParseException {
    ...
    @Test
    public void loadGames_equalLists() throws IOException, ParseException {
        String data = GameDataCsvString.ALL_DATA_HEADER + GameDataCsvString.ALL_DATA;
    ...
    @Test
    public void storeGames_returnsSomething() throws IOException {
    ...
    @Test
    public void storeGames_equals() throws IOException {
        SteamBackend steamBackend = new SteamBackend();
        steamBackend.setGames(DataHelper.smallGameList());
