package com.example.testrechner;
...
import com.example.testrechner.arithmeticutils.PostFixConverter;
import com.example.testrechner.arithmeticutils.PostFixCalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void gleich(View view) {
        rechenfeld.setText(new PostFixConverter(rechenfeld.getText().toString()).getfixExpression());
