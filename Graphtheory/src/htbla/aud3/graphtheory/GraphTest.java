...
public class GraphTest {
    ...
    public void a1_determineShortestPathBasic() {
        ...
        g.read(findFile("Linz_Suchproblem.csv")); // getFile("Linz_Suchproblem.csv")
    ...
    public void a2_determineShortestPathAdvanced() {
        ...
        Graph g = new Graph();
        g.read(findFile("Linz_Suchproblem.csv"));
    ...
    private File getFile(String fileName) {
        System.out.println(GraphTest.class.getResource(fileName));

        InputStream is = GraphTest.class.getResourceAsStream(fileName);
